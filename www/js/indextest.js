 ...
 * under the License.
 */
const gVer = "1.31.T071122";  // VERSION MUST be n.nn. ...  e.g. 1.07 for version comparison to work.
...
var gGetCache1=0, gGetCache2=0, gGetCache3=0, gGetCache4=0;
...
function DisplayLoadTimes() {
    var gc1= gGetCache2-gGetCache1;var gc2 = gGetCache3-gGetCache2;var gc3 = gGetCache4 - gGetCache3;
    document.getElementById("reloadtime").innerHTML = "<br/>Stats:<br/>App started " + gAppStartedDate +
        ...
        "<br/>Cache:fetch=" + gc1 + ",loadcache=" + gc2 + ",loadevents=" + gc3 + ", tot=" + (gc1+gc2+gc3);
