...
//
    ...
    //    else $fire = '<span style="color:green">No Ban</span>';
    //}
    $fire = '<a href="http://www.co.pierce.wa.us/index.aspx?NID=982" style="color:red;font-weight:bold">County-wide Outdoor Burn Ban</a>'; // rfb 8/19
    // write it
