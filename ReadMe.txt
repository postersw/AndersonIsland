...
04/15/20. Ver 1.27.041120 IOS Testflight beta build. The 1st IOS build not using PGBuild. Built on MacinCloud LA952 (pw=pxt77203) using XCode 11 for IOS 13.
                          Fix FERRY LOCATION link to call external browser (from Android 1.25).
----------------------------------------------------------------------------------------------------------------------------------------
