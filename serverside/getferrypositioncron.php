...
//  1.39 11/30/22. Add ETD for ToAI and ToST runs & Remove 2 minute subtraction.
...
function checkforLateFerry() {
    ...
    switch($ferrystate) {
        ...
        case "toAI": // travelling to AI
            ...
            $delaymsg = "LATE $delaytime min. for " . substr($ferrystate, 2) . " " . ftime($nextrun)  . " run. ETD: " . ftime($TED) . "<br/>";  
            break;
